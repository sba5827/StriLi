...
## How to Install
Download the latest [releases](https://github.com/sba5827/StriLi/releases/tag/2.04). Unzip the folder to your WoW Addons folder. Eg.:
...
Laden Sie die neuesten [Versionen](https://github.com/sba5827/StriLi/releases/tag/2.04) herunter. Entpacken Sie den Ordner in Ihren WoW Addons Ordner. z.B.:
